import type { DeletePostMutation, DeletePostMutationVariables, FindPostById } from 'types/graphql'
...
const DELETE_POST_MUTATION: TypedDocumentNode<DeletePostMutation, DeletePostMutationVariables> =
  gql`
