...
import { contacts, contact, createContact, updateContact, deleteContact } from './contacts'
  ...
  scenario('creates a contact', async () => {
    const result = await createContact({
      input: {
        ...
        email: 'String',
        message: 'String',
        updatedAt: '2024-09-15T00:23:28.409Z'
      }
    })
    ...
    expect(result.updatedAt).toEqual(new Date('2024-09-15T00:23:28.409Z'))
  })
